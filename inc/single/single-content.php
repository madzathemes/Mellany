    ...
    <?php if ( get_the_author_meta( 'description' )) { ?>
      <div class="author-info">
        <div class="author-avatar">
          <?php echo get_avatar( get_the_author_meta( 'user_email' ), apply_filters( 'mellany_author_bio_avatar_size', 30 ) ); ?>
        </div>
        <div class="author-description">
          <h2><?php printf( esc_html__( 'About %s', 'mellany' ), get_the_author() ); ?></h2>
